...
The sleep-memory association premise is our explanation's statistical law of nature premise.
Considering our explanation about Carl again, suppose that we omitted the sleep-memory association premise.
In fact, it might seem natural to say that our explanation is still good explanation; however, I think there are at least two problems with this intuition.
